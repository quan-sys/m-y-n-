...
## Step 5 - The flag does not cover the harm channel

- HAG 2023Q4 has interest_expenses = +951800507000.0 VND (POSITIVE) and financial_expenses = +995815777000.0 VND (POSITIVE).
- `abs(interest_expenses) > abs(financial_expenses)` is false for HAG 2023Q4, so this ticker-quarter is outside the 545-row flagged population.
- HAG 2023Q4 is inside the TTM window for rebalance dates 2024-03-31, 2024-06-30, 2024-09-30, and 2024-12-31.
- The positive-interest population has 74 ticker-quarters across 55 distinct tickers, from 2018Q2 through 2026Q2; 24 are inside the 545-row flagged population and 50 are outside it.
- ebit_tev target rows with at least one positive interest_expenses ticker-quarter in the committed TTM window: 75.

The 545-row flag does not cover the full positive-interest harm channel because 50 of the 74 positive-interest ticker-quarters are outside that flagged population.
